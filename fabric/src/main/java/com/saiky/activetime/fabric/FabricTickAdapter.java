...
/**
 * Native Fabric tick adapter.
 * Directly interacts with Minecraft 1.20.3+ ServerTickRateManager with safe command fallback.
 */
public class FabricTickAdapter implements TickManagerAdapter {

    private final Object server;
    private final Logger logger;

    public FabricTickAdapter(Object server, Logger logger) {
        this.server = server;
        this.logger = logger;
    }
    ...
    public void setFrozen(boolean frozen) {
        ...
        // Fallback to Minecraft's native /tick freeze command
